...
export const fetchTodo = () => (dispatch) => {
  ...
  axios
  .get("https://todo-fs-rm.herokuapp.com/todo/")
  .then(data => {
...
export const addToDo = (todo) => (dispatch) =>{
    dispatch({type: FETCH_TODO_START})
    axios
    .post("https://todo-fs-rm.herokuapp.com/todo/", todo)
  ...
  export const updateTodo = (id, update) => (dispatch) =>{
    dispatch({type: FETCH_TODO_START})
    axios
    .put(`https://todo-fs-rm.herokuapp.com/todo/${id}`, update)
  ...
  export const removeToDo = (id, todo) => (dispatch) => {
    dispatch({type: FETCH_TODO_START})
      axios
      .delete(`https://todo-fs-rm.herokuapp.com/todo/${id}`)
